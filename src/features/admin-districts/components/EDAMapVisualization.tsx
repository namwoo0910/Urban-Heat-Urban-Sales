...
import { DistrictChartPanel } from './charts/DistrictChartPanel'
  ...
  return (
    <div className="relative w-full h-full flex">
      ...
      <button
        ...
        className="absolute top-[66px] right-4 z-20 px-4 py-2 bg-purple-600/80 hover:bg-purple-600 text-white rounded-lg transition-colors flex items-center gap-2"
      >
