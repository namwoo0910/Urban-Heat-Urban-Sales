...
function parseCsvToBoxPlotData(csvText: string): BoxPlotDataPoint[] {
  ...
  return lines.slice(1).map(line => {
    ...
    return {
      category: values[0],
      cold: {
        min: parseFloat(values[1]) || 0,
        Q1: parseFloat(values[2]) || 0,
        median: parseFloat(values[3]) || 0,
        Q3: parseFloat(values[4]) || 0,
        max: parseFloat(values[5]) || 0,
        mean: parseFloat(values[6]) || 0,
        lowerWhisker: parseFloat(values[7]) || 0,
        upperWhisker: parseFloat(values[8]) || 0,
      },
      mild: {
        min: parseFloat(values[9]) || 0,
        Q1: parseFloat(values[10]) || 0,
        median: parseFloat(values[11]) || 0,
        Q3: parseFloat(values[12]) || 0,
        max: parseFloat(values[13]) || 0,
        mean: parseFloat(values[14]) || 0,
        lowerWhisker: parseFloat(values[15]) || 0,
        upperWhisker: parseFloat(values[16]) || 0,
      },
      hot: {
        min: parseFloat(values[17]) || 0,
        Q1: parseFloat(values[18]) || 0,
        median: parseFloat(values[19]) || 0,
        Q3: parseFloat(values[20]) || 0,
        max: parseFloat(values[21]) || 0,
        mean: parseFloat(values[22]) || 0,
        lowerWhisker: parseFloat(values[23]) || 0,
        upperWhisker: parseFloat(values[24]) || 0,
      },
    }
